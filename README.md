...
The project is licensed under [Apache-2.0](LICENSE). The reviewed Python package, application, and
quickstart image version is `0.5.0`. Compose pins the published image by its verified immutable
registry digest.
