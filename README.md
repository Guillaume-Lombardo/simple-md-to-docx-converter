...
version is `0.5.0`. Until the post-publication pin update completes, the quickstart remains pinned
by immutable registry digest to the verified `0.4.0` release.
