...
def create_app(  # noqa: PLR0913 - explicit lifecycle composition inputs
    ...
    *,
    ...
    routers = (
        ...
        composer_authors.build_router(dependencies),
        composer_connections.build_router(dependencies),
        composer_drafts.build_router(dependencies),
        composer_generations.build_router(dependencies),
        composer_fill_templates.build_router(dependencies),
        composer_fills.build_router(dependencies),
