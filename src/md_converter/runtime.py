...
from md_converter.app import build_components, create_app
from md_converter.config import ConfigurationError, Settings, StorageProfile
from md_converter.conversion.processor import build_production_processor
...
def main(arguments: Sequence[str] | None = None) -> int:
    ...
    if selected == ("external-worker",):
        ...
        return 0
    raise SystemExit(
        "usage: python -m md_converter.runtime <embedded-worker|external-worker>"
    )
