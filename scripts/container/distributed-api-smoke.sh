...
MARKWEAVE_TEST_S3_ACCESS_KEY_ID=t20integration \
MARKWEAVE_TEST_S3_BUCKET=md-converter-t20 \
MARKWEAVE_TEST_S3_ENDPOINT_URL="http://127.0.0.1:$rustfs_port" \
MARKWEAVE_TEST_S3_REGION=us-east-1 \
MARKWEAVE_TEST_S3_SECRET_ACCESS_KEY=t20integrationsecret \
  uv run python -m scripts.ci.prepare_s3_test_bucket

settings=(
  --env MARKWEAVE_INITIAL_ADMIN_USERNAME=admin
  --env MARKWEAVE_INITIAL_ADMIN_PASSWORD=t20-test-password
  --env MARKWEAVE_STORAGE_PROFILE=distributed
  --env MARKWEAVE_DISTRIBUTED_DATABASE_URL=postgresql+psycopg://postgres:t20-ci-password@postgres:5432/md_converter_test
  --env MARKWEAVE_S3_BUCKET=md-converter-t20
  --env MARKWEAVE_S3_ENDPOINT_URL=http://rustfs:9000
  --env MARKWEAVE_S3_REGION=us-east-1
  --env MARKWEAVE_S3_ACCESS_KEY_ID=t20integration
  --env MARKWEAVE_S3_SECRET_ACCESS_KEY=t20integrationsecret
  ...
  --env MARKWEAVE_CONVERSION_PDF_MAX_PAGES=100
  ...
  --env MARKWEAVE_JOB_RESULT_RETENTION_SECONDS=3600
  --env MARKWEAVE_JOB_ACTIVE_LIMIT_PER_USER=2
  --env MARKWEAVE_JOB_GLOBAL_QUEUE_CAPACITY=10
  --env MARKWEAVE_JOB_MAX_DURATION_SECONDS=60
  ...
  --env MARKWEAVE_WORKER_IDLE_POLL_SECONDS=0.25
  --env MARKWEAVE_WORKER_ERROR_BACKOFF_SECONDS=1
  --env MARKWEAVE_WORKER_CLEANUP_INTERVAL_SECONDS=60
  ...
  --env MARKWEAVE_TEMPLATE_ENGINE_TIMEOUT_SECONDS=10
