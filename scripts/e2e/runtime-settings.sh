...
e2e_runtime_settings() {
  E2E_SETTINGS=(
    --env MD_CONVERTER_INITIAL_ADMIN_USERNAME=e2e-admin
    --env MD_CONVERTER_INITIAL_ADMIN_PASSWORD=e2e-admin-password
    --env MD_CONVERTER_SESSION_IDLE_SECONDS=60
    --env MD_CONVERTER_SESSION_ABSOLUTE_SECONDS=60
    ...
    --env MD_CONVERTER_CONVERSION_PDF_MAX_PAGES=5
    ...
    --env MD_CONVERTER_JOB_RESULT_RETENTION_SECONDS=60
    --env MD_CONVERTER_JOB_ACTIVE_LIMIT_PER_USER=8
    --env MD_CONVERTER_JOB_GLOBAL_QUEUE_CAPACITY=24
    --env MD_CONVERTER_JOB_MAX_DURATION_SECONDS=90
    ...
    --env MD_CONVERTER_WORKER_IDLE_POLL_SECONDS=0.1
    --env MD_CONVERTER_WORKER_ERROR_BACKOFF_SECONDS=0.25
    --env MD_CONVERTER_WORKER_CLEANUP_INTERVAL_SECONDS=1
    ...
    --env MD_CONVERTER_TEMPLATE_ENGINE_TIMEOUT_SECONDS=15
    ...
    --env MD_CONVERTER_CLAMAV_HOST=e2e-clamav
  )
}
