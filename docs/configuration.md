...
digest must agree; do not copy forward-conversion limits or use an unpublished image digest. Use only
the exact release manifest for a published three-image set. See the
