...
The expanded mutation workflow runs its selector, verifier, manifest, and locked environment from
the trusted pull-request base (or default branch), while Mutmut runs only against the pull-request
target. Its five bounded domains cover
