...
* Status: In Progress.
* T38 is independently completable once its source-built entrypoint change is verified on `main`; T54 remains blocked by T38 and owns the subsequent public published-image migration.
