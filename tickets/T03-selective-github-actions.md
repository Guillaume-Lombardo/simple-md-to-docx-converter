...
- 2026-08-23: Pinned `actions/checkout` v7.0.1, `actions/setup-python` v7.0.0, and
  ...
  requests from saving caches, cancels superseded PR/merge-group runs, and bounds every job.
- 2026-08-23: Added unit tests for path selection, lifecycle enforcement, workflow policy, and the
  ...
  command propagation. All 29 default and full tests pass; the unit/light selection passes with
  98.13% combined branch coverage. Locked synchronization, Ruff format/lint, `ty`, both canonical
