...
* 2026-08-30: Independent review approved T44 at `1e7e2f6`. Merged current `main` at `e453a28` normally through merge commit `381d1bf`; all six T44 patches remain identical in `git range-diff`, with no conflicts or semantic delta. Post-merge validation passes 172 targeted T44 tests, 82 CLI/T32 compatibility tests, three lifecycle stress runs of 25 tests, four documentation tests, Ruff, `ty`, and diff validation.
