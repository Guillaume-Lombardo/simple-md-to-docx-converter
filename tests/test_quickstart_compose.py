...
MARKWEAVE_DIGEST = (
    "ghcr.io/guillaume-lombardo/md-converter:0.6.4@"
    "sha256:89a1eb87a87735441feb4d8dfee46bc597e948873ccd1808065f7d92acde19d5"
)
FRONTEND_DIGEST = (
    "ghcr.io/guillaume-lombardo/md-converter-web:0.6.4@"
...
def test_podman_insecure_e2e_proves_host_routing_and_bounded_cleanup() -> None:
    ...
    assert "grep -Fx 'ROUTER_HOST=0.0.0.0' >/dev/null" in runner
    assert "grep -Fqx 'ROUTER_HOST=0.0.0.0'" not in runner
